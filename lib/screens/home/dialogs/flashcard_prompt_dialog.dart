...
Future<void> showFlashcardPromptDialog(
  ...
  final result = await showDialog<Map<String, dynamic>>(
    ...
    builder: (BuildContext context) => const _FlashcardPromptDialogContent(),
  );
...
class _FlashcardPromptDialogContent extends StatefulWidget {
  const _FlashcardPromptDialogContent();

  @override
  State<_FlashcardPromptDialogContent> createState() =>
      _FlashcardPromptDialogContentState();
}

class _FlashcardPromptDialogContentState
    extends State<_FlashcardPromptDialogContent> {
  final List<String> _flashcardTypes = [
    'Q&A',
    'Definition',
    'Concept Explanation',
    'Term & Definition',
  ...
  void initState() {
    ...
    _selectedType = _flashcardTypes.first;
  }
